...
- Documentación de tablas y esquema:
  [docs/supabase-database.md](docs/supabase-database.md)
- Script SQL base para Supabase: [supabase/schema.sql](supabase/schema.sql)
- Variables de entorno de ejemplo: [.env.example](.env.example)

Para conectar el proyecto a Supabase, copia [.env.example](.env.example) a
`.env.local` y completa las variables `VITE_SUPABASE_URL` y
